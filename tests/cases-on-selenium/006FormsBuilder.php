...
class FormsBuilderTest extends TooBasic_SeleniumTestCase {
	...
	public function testSettingFormsMethod() {
		//
		// Default.
	...
	public function testSettingFormsTypeAsBootstrap() {
		//
		// Default.
		$this->runFormCommand("php shell.php sys forms --set-type 'bootstrap' -f {$this->_formName}", "Setting form '{$this->_formName}' type:(.*)Done");
	}
	public function testSettingFormsFields() {
	...
	public function testSettingFormsAttributes() {
	...
	public function testSettingFieldsAttributes() {
		foreach(['name', 'age', 'status', 'description'] as $field) {
			$this->runFormCommand("php shell.php sys forms --set-field-attribute {$field} -f {$this->_formName} -n class -v input-sm", "Setting field '{$field}' attribute 'class' \(in form '{$this->_formName}'\):(.*)Done");
		}
	}
	public function testSettingFormsButtons() {
		//
		// Defaults.
	...
	public function testSettingButtonsAttributes() {
		//
		// Defaults.
		$this->runFormCommand("php shell.php sys forms --set-button-attribute send -f {$this->_formName} -n class -v 'btn-sm btn-success'", "Setting button 'send' attribute 'class' \(in form '{$this->_formName}'\):(.*)Done");
		$this->runFormCommand("php shell.php sys forms --set-button-attribute reset -f {$this->_formName} -n class -v 'btn-sm btn-info'", "Setting button 'reset' attribute 'class' \(in form '{$this->_formName}'\):(.*)Done");
		$this->runFormCommand("php shell.php sys forms --set-button-attribute back -f {$this->_formName} -n class -v 'btn-sm btn-default'", "Setting button 'back' attribute 'class' \(in form '{$this->_formName}'\):(.*)Done");
		//
		// Specific for mode 'create'.
		$this->runFormCommand("php shell.php sys forms --set-button-attribute create -f {$this->_formName} -n class -v 'btn-sm btn-success' -m create", "Setting button 'create' attribute 'class' \(in form '{$this->_formName}' and mode 'create'\):(.*)Done");
		$this->runFormCommand("php shell.php sys forms --set-button-attribute reset -f {$this->_formName} -n class -v 'btn-sm btn-info' -m create", "Setting button 'reset' attribute 'class' \(in form '{$this->_formName}' and mode 'create'\):(.*)Done");
		$this->runFormCommand("php shell.php sys forms --set-button-attribute back -f {$this->_formName} -n class -v 'btn-sm btn-default' -m create", "Setting button 'back' attribute 'class' \(in form '{$this->_formName}' and mode 'create'\):(.*)Done");
	}
	// @}
	//
	// Analysis @{
	...
	protected function validateFormButtons($form, $isCreate = false) {
		...
		// Send button.
		if($isCreate) {
			$this->assertNotNull($buttons[0]->attribute('class'), "Send button attribute 'class' is not present.");
			$this->assertEquals('btn btn-sm btn-success', $buttons[0]->attribute('class'), "Send button attribute 'class' has an unexpected value.");
		...
		$this->assertEquals('btn btn-sm btn-info', $buttons[1]->attribute('class'), "Reset button attribute 'class' has an unexpected value.");
